...
public class Goblin extends Humanoid {
    ...
    public Goblin(String name, int hp, int speed, int ac, int strength, int dexterity, int constitution, int intelligence, int wisdom, int charisma){
        this.name=name;
        this.hp = hp;
        this.speed = speed;
        this.ac = ac;
    ...
    public Goblin(String name, int hp, int ac, int strength){
        this.name=name;
        this.hp=hp;
        this.ac=ac;
        this.strength=strength;
